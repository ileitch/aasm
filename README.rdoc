...
This example uses a few of the more complex features available.
  ...
  class Relationship
    ...
    # Raise an AASMPersistenceFailure error if the state cannot be updated due to validation errors on the ActiveRecord model.
    # Default is false. Only available on ActiveRecord models.
    aasm_raise_on_persistence_failure true
